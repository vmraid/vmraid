...
def get_pdf(html, options=None, output=None):
	...
	if "password" in options:
		...
		if six.PY2:
			password = vmraid.safe_encode(password)
...
def prepare_options(html, options):
	...
	if not options.get("page-size"):
		options['page-size'] = vmraid.db.get_single_value("Print Settings", "pdf_page_size") or "A4"
...
def prepare_header_footer(soup):
	...
	for html_id in ("header-html", "footer-html"):
		...
		if content:
			...
			html = vmraid.render_template("templates/print_formats/pdf_header_footer.html", {
				"head": head,
				"content": content,
				"styles": styles,
				"html_id": html_id,
