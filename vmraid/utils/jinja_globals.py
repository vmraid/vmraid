...
def inspect(var, render=True):
	from vmraid.utils.jinja import get_jenv
...
def web_blocks(blocks):
	from vmraid import _, _dict, throw
	from vmraid.website.doctype.web_page.web_page import get_web_blocks_html
...
def get_dom_id(seed=None):
	from vmraid import generate_hash
...
def bundled_asset(path, rtl=None):
	from vmraid.utils import get_assets_json
	from vmraid.website.utils import abs_url
