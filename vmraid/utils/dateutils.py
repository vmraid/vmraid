...
import datetime
from vmraid.utils import get_datetime, add_to_date, getdate
from vmraid.utils.data import get_first_day, get_first_day_of_week, get_quarter_start, get_year_start,\
...
def get_user_date_format():
	if getattr(vmraid.local, "user_date_format", None) is None:
		vmraid.local.user_date_format = vmraid.defaults.get_global_default("date_format") or "yyyy-mm-dd"

	return vmraid.local.user_date_format
