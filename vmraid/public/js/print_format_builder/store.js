		...
		methods: {
			fetch() {
				return new Promise(resolve => {
					vmraid.model.clear_doc(
						"Print Format",
						this.print_format_name
					);
					vmraid.model.with_doc(
						"Print Format",
						this.print_format_name,
						() => {
							let print_format = vmraid.get_doc(
								"Print Format",
								this.print_format_name
							);
							vmraid.model.with_doctype(
								print_format.doc_type,
								() => {
									this.meta = vmraid.get_meta(
										print_format.doc_type
									);
