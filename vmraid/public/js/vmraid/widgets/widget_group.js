...
vmraid.provide("vmraid.widget");

vmraid.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
vmraid.widget.make_widget = (opts) => {
	const widget_class = vmraid.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = vmraid.widget.make_widget({
			...widget,
...
vmraid.widget.WidgetGroup = WidgetGroup;
vmraid.widget.SingleWidgetGroup = SingleWidgetGroup;
