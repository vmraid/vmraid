...
export default class WebForm extends vmraid.ui.FieldGroup {
	...
	setup_delete_button() {
		vmraid.has_permission(this.doc_type, "", "delete", () => {
			this.add_button_to_header(
				vmraid.utils.icon('delete'),
				"danger",
				() => this.delete()
			);
		});
	...
	delete() {
		vmraid.call({
			type: "POST",
			method: "vmraid.website.doctype.web_form.web_form.delete",
			args: {
	...
	handle_success(data) {
		...
		const success_dialog = new vmraid.ui.Dialog({
