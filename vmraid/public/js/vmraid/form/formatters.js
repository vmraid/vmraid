...
vmraid.form.formatters = {
	...
	Datetime: function(value) {
		if(value) {
			return moment(vmraid.datetime.convert_to_user_tz(value))
				.format(vmraid.boot.sysdefaults.date_format.toUpperCase() + ' ' + vmraid.boot.sysdefaults.time_format || 'HH:mm:ss');
		} else {
			return "";
		}
	},
	...
	Icon: (value) => {
		return value ? `<div>
			<div class="selected-icon">${vmraid.utils.icon(value, "md")}</div>
