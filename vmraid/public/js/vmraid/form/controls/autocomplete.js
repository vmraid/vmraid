...
vmraid.ui.form.ControlAutocomplete = class ControlAutoComplete extends vmraid.ui.form.ControlData {
	...
	setup_awesomplete() {
		...
		this.$input.on('input', vmraid.utils.debounce((e) => {
	...
	parse_options(options) {
		if (typeof options === 'string' && options[0] === '[') {
			options = vmraid.utils.parse_json(options);
		}
