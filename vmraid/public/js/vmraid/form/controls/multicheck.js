vmraid.ui.form.ControlMultiCheck = class ControlMultiCheck extends vmraid.ui.form.Control {
	...
	parse_df_options() {
		...
		} else if(this.df.options && this.df.options.length>0 && vmraid.utils.is_json(this.df.options)) {
