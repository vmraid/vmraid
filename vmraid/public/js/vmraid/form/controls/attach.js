vmraid.ui.form.ControlAttach = class ControlAttach extends vmraid.ui.form.ControlData {
	make_input() {
		let me = this;
		...
		vmraid.utils.bind_actions_with_object(this.$value, this);
	...
	on_attach_click() {
		...
		this.file_uploader = new vmraid.ui.FileUploader(this.upload_options);
	}
	set_upload_options() {
		let options = {
