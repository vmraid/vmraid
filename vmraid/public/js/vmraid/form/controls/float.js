vmraid.ui.form.ControlFloat = class ControlFloat extends vmraid.ui.form.ControlInt {
	parse(value) {
	...
	get_number_format() {
		var currency = vmraid.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(vmraid.boot.sysdefaults.float_precision, null);
	}
};

vmraid.ui.form.ControlPercent = vmraid.ui.form.ControlFloat;
