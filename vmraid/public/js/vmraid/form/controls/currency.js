vmraid.ui.form.ControlCurrency = class ControlCurrency extends vmraid.ui.form.ControlFloat {
	...
	get_precision() {
		...
		if (!this.df.precision) {
			if(vmraid.boot.sysdefaults.currency_precision) {
				this.df.precision = vmraid.boot.sysdefaults.currency_precision;
			} else {
