vmraid.ui.form.ControlSignature = class ControlSignature extends vmraid.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
	...
	make_pad() {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${vmraid.utils.icon('restriction', 'md')}</i>
			</div></div>`)
	...
	load_lib() {
		if (!this.load_lib_promise) {
			this.load_lib_promise = vmraid.require('/assets/vmraid/js/lib/jSignature.min.js');
		}
