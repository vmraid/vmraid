		...
		return navigator.mediaDevices.getUserMedia({ video: true }).then(stream => {
			...
			const set_take_photo_action = () => {
				this.dialog.set_primary_action(__('Take Photo'), () => {
					const data_url = vmraid._.get_data_uri(video);
			...
			const $e = $(vmraid.ui.Capture.TEMPLATE);
...
<div class="vmraid-capture">
	<div class="panel panel-default">
		<div class="embed-responsive embed-responsive-16by9">
			...
			<video class="fc-s embed-responsive-item">${vmraid.ui.Capture.ERR_MESSAGE}</video>
		</div>
	</div>
</div>
`;
