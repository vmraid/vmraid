...
vmraid.msgprint = function(msg, title, is_minimizable) {
	...
	if(data.title || !msg_exists) {
		...
		vmraid.msg_dialog.set_title(data.title || __('Message', null, 'Default title of the message dialog'));
	}
...
// Floating Message
vmraid.show_alert = vmraid.toast = function(message, seconds=7, actions={}) {
