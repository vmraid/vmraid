...
from vmraid.query_builder import get_query_builder, patch_query_aggregation, patch_query_execute
...
def _(msg, lang=None, context=None):
	...
	from vmraid.utils import is_html, strip_html_tags
...
if TYPE_CHECKING:
	...
	from vmraid.query_builder.builder import MariaDB, Postgres
...
def has_permission(
	...
	out = vmraid.permissions.has_permission(
		doctype,
		ptype,
		doc=doc,
		verbose=verbose,
...
def delete_doc(
	...
	vmraid.model.delete_doc.delete_doc(
		doctype,
		name,
		force,
		ignore_doctypes,
...
def get_version(doctype, name, limit=None, head=False, raise_err=True):
	...
	if meta.track_changes:
		...
		from vmraid.utils import dictify, safe_json_loads, squashify
...
def mock(type, size=1, locale="en"):
	...
	from vmraid.utils import squashify
