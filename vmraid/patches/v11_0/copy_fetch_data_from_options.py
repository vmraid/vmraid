...
def execute():
	vmraid.reload_doc("core", "doctype", "docfield", force=True)
	vmraid.reload_doc("custom", "doctype", "custom_field", force=True)
	vmraid.reload_doc("custom", "doctype", "customize_form_field", force=True)
	vmraid.reload_doc("custom", "doctype", "property_setter", force=True)
