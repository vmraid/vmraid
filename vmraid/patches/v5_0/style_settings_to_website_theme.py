...
def execute():
	vmraid.reload_doc("website", "doctype", "website_theme")
	vmraid.reload_doc("website", "website_theme", "standard")
	vmraid.reload_doctype("Website Settings")
	migrate_style_settings()
	vmraid.delete_doc("website", "doctype", "style_settings")

def migrate_style_settings():
	style_settings = vmraid.db.get_singles_dict("Style Settings")
	standard_website_theme = vmraid.get_doc("Website Theme", "Standard")

	website_theme = vmraid.copy_doc(standard_website_theme)
	...
	website_theme.no_sidebar = cint(vmraid.db.get_single_value("Website Settings", "no_sidebar"))
