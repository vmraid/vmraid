...
def execute():
	...
	for chart in charts_to_modify:
		...
		if chart.filters_json and isinstance(old_filters, dict):
			...
			vmraid.db.set_value('Dashboard Chart', chart.name, 'filters_json', new_filters_json)