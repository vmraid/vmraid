...
def execute():
	...
	for count, contact_detail in enumerate(contact_details):
		...
		if contact_detail.email_id:
			email_values.append((
				1,
				vmraid.generate_hash(contact_detail.email_id, 10),
	...
	vmraid.db.add_index("Contact Phone", ["phone"])
	vmraid.db.add_index("Contact Email", ["email_id"])