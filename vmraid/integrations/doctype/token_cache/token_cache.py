...
class TokenCache(Document):
	def get_auth_header(self):
		...
		raise vmraid.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			vmraid.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
	...
	def get_expires_in(self):
		expiry_time = vmraid.utils.get_datetime(self.modified) + timedelta(self.expires_in)
