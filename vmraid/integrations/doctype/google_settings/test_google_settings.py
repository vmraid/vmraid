...
class TestGoogleSettings(unittest.TestCase):
	def setUp(self):
		settings = vmraid.get_single("Google Settings")
	...
	def test_picker_disabled(self):
		...
		vmraid.db.set_value("Google Settings", None, "enable", 1)
		vmraid.db.set_value("Google Settings", None, "google_drive_picker_enabled", 0)
	...
	def test_google_disabled(self):
		...
		vmraid.db.set_value("Google Settings", None, "enable", 0)
		vmraid.db.set_value("Google Settings", None, "google_drive_picker_enabled", 1)
		settings = get_file_picker_settings()
