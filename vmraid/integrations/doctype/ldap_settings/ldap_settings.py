...
from vmraid.twofactor import authenticate_for_2factor, confirm_otp_token, should_run_2fa
...
class LDAPSettings(Document):
	...
	def sync_roles(self, user, additional_groups=None):
		...
		matched_roles = {
			r.erpadda_role for r in self.ldap_groups if r.ldap_group.lower() in lower_groups
		}
	...
	def authenticate(self, username, password):
		...
		try:
			...
			vmraid.throw(_("Please use a valid LDAP search filter"), title=_("Misconfigured"))
