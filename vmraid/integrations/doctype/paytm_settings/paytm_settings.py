...
from vmraid.integrations.utils import create_payment_gateway, create_request_log
from vmraid.model.document import Document
from vmraid.utils import call_hook_method, cint, cstr, flt, get_request_site_address, get_url
...
def get_paytm_params(payment_details, order_id, paytm_config):
	...
	redirect_uri = (
		...
		+ "/api/method/vmraid.integrations.doctype.paytm_settings.paytm_settings.verify_transaction"
	)
...
def get_gateway_controller(doctype, docname):
	...
	gateway_controller = vmraid.db.get_value(
