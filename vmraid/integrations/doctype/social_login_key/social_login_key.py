...
class BaseUrlNotSetError(vmraid.ValidationError):
	pass


class AuthorizeUrlNotSetError(vmraid.ValidationError):
	pass


class AccessTokenUrlNotSetError(vmraid.ValidationError):
	pass


class RedirectUrlNotSetError(vmraid.ValidationError):
	pass


class ClientIDNotSetError(vmraid.ValidationError):
	pass


class ClientSecretNotSetError(vmraid.ValidationError):
	pass
