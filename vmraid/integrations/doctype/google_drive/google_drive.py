...
from vmraid.utils import get_backups_path, get_chair_path, get_request_site_address
...
def authorize_access(reauthorize=None):
	...
	redirect_uri = (
		...
		+ "?cmd=vmraid.integrations.doctype.google_drive.google_drive.google_callback"
	)
...
def take_backup():
	...
	enqueue(
		"vmraid.integrations.doctype.google_drive.google_drive.upload_system_backup_to_google_drive",
		queue="long",
		timeout=1500,
	)
