...
def vmraidcloud_migrator(local_site):
	print("Retrieving Site Migrator...")
	remote_site = vmraid.conf.vmraidcloud_url or "vmraidcloud.com"
	...
	if request.status_code / 100 != 2:
		...
		click.secho("Some errors occurred while recovering the migration script. Please contact us @ VMRaid Cloud if this issue persists", fg="yellow")
		return
