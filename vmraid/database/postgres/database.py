...
from vmraid.database.postgres.schema import PostgresTable
from vmraid.utils import cstr, get_table_name
		...
		return [
			...
			where table_catalog='{0}'
				...
				and table_schema='{1}'""".format(
					vmraid.conf.db_name, vmraid.conf.get("db_schema", "public")
				)
			)
		]
