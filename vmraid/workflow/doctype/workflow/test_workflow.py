...
from vmraid.model.workflow import apply_workflow, WorkflowTransitionError, WorkflowPermissionError, get_common_transition_actions
...
def create_todo_workflow():
	...
	if not vmraid.db.exists('Role', 'Test Approver'):
		vmraid.get_doc(dict(doctype='Role',
