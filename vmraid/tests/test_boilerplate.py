...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		...
		cls.chair_path = vmraid.utils.get_chair_path()
		cls.apps_dir = os.path.join(cls.chair_path, "apps")
	...
	def tearDownClass(cls):
		test_app_dirs = (os.path.join(cls.chair_path, "apps", app_name) for app_name in cls.app_names)
	...
	def test_create_app(self):
		...
		new_app_dir = os.path.join(self.chair_path, self.apps_dir, self.app_names[0])
