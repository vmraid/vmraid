...
from vmraid.desk.doctype.desktop_icon.desktop_icon import (get_desktop_icons, add_user_icon,
...
class TestDomainification(unittest.TestCase):
	...
	def tearDown(self):
		vmraid.db.sql("delete from tabRole where name='_Test Role'")
		vmraid.db.sql("delete from `tabHas Role` where role='_Test Role'")
		vmraid.db.sql("delete from tabDomain where name in ('_Test Domain 1', '_Test Domain 2')")
