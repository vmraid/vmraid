...
from vmraid.model.naming import revert_series_if_last, make_autoname, parse_naming_series
...
class TestDocument(unittest.TestCase):
	...
	def test_insert(self):
		...
		self.assertEqual(vmraid.db.get_value("Event", d.name, "subject"),
