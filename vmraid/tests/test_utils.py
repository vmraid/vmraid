...
from vmraid.utils import evaluate_filters, money_in_words, scrub_urls, get_url
from vmraid.utils import validate_url, validate_email_address
from vmraid.utils import ceil, floor
...
class TestDataManipulation(unittest.TestCase):
	def test_scrub_urls(self):
		...
		self.assertTrue('style="background-image: url(\'{0}/assets/vmraid/bg.jpg\') !important"'.format(url) in html)
...
class TestValidationUtils(unittest.TestCase):
	def test_valid_url(self):
		...
		self.assertFalse(validate_url('bolo://vmraid.io', valid_schemes=("http", "https", "ftp", "ftps")))
		self.assertRaises(
...
class TestImage(unittest.TestCase):
	def test_strip_exif_data(self):
		...
		original_image_content = io.open("../apps/vmraid/vmraid/tests/data/exif_sample_image.jpg", mode='rb').read()
