...
class TestReportview(unittest.TestCase):
	...
	def test_query_fields_sanitizer(self):
		self.assertRaises(vmraid.DataError, DatabaseQuery("DocType").execute,
	...
	def test_of_not_of_descendant_ancestors(self):
		...
		self.assertTrue(len(vmraid.get_all('Nested DocType', {'name': ('not ancestors of', 'Root')})) == len(vmraid.get_all('Nested DocType')))
	...
	def test_set_field_tables(self):
		...
		data = vmraid.db.get_list("Web Form",
