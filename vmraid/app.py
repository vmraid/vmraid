...
def init_request(request):
	...
	request.max_content_length = vmraid.local.conf.get("max_file_size") or 10 * 1024 * 1024
...
def handle_exception(e):
	...
	respond_as_json = (
		...
		or (vmraid.local.request.path.startswith("/api/") and not accept_header.startswith("text"))
	)
