...
app_email = "developers@vmraid.io"

docs_app = "vmraid_docs"
...
page_js = {"setup-wizard": "public/js/vmraid/setup_wizard.js"}
...
on_logout = (
	"vmraid.core.doctype.session_default_settings.session_default_settings.clear_session_defaults"
)
...
standard_queries = {"User": "vmraid.core.doctype.user.user.user_query"}
...
scheduler_events = {
	...
	"hourly": [
		...
		"vmraid.website.doctype.personal_data_deletion_request.personal_data_deletion_request.process_data_deletion_request",
	],
	"daily": [
