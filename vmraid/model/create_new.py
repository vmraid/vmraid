...
from vmraid.utils import nowdate, nowtime, now_datetime, cstr
...
def get_default_based_on_another_field(df, user_permissions, parent_doc):
	...
	reference_name = parent_doc.get(ref_fieldname) if parent_doc else vmraid.db.get_default(ref_fieldname)
