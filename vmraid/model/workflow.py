...
class WorkflowStateError(vmraid.ValidationError):
	pass


class WorkflowTransitionError(vmraid.ValidationError):
	pass


class WorkflowPermissionError(vmraid.ValidationError):
	pass
...
def get_workflow_name(doctype):
	...
	if workflow_name is None:
		workflow_name = vmraid.db.get_value(
