...
from vmraid.social.doctype.energy_point_log.energy_point_log import create_review_points_log
from vmraid.utils import add_to_date, today, getdate

class EnergyPointSettings(Document):
	pass

def is_energy_point_enabled():
	return vmraid.db.get_single_value('Energy Point Settings', 'enabled', True)
