...
class TestEnergyPointLog(VMRaidTestCase):
	@classmethod
	def setUpClass(cls):
	...
	def tearDown(self):
		...
		vmraid.db.delete("Energy Point Log")
		vmraid.db.delete("Energy Point Rule")
		vmraid.cache().delete_value("energy_point_rule_map")
...
def create_energy_point_rule_for_todo(
	...
	if point_rule_exists:
		return vmraid.get_doc("Energy Point Rule", name)
