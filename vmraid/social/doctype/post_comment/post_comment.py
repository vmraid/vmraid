...
class PostComment(Document):
	def after_insert(self):
		...
		for mention in mentions:
			...
			vmraid.publish_realtime('mention', """{} mentioned you!
				<br><a class="text-muted text-small" href="desk#social/home">Check Social<a>"""
					.format(vmraid.utils.get_fullname(self.owner)),
				user=mention,
				after_commit=True)
		vmraid.publish_realtime('new_post_comment' + self.parent, self, after_commit=True)
