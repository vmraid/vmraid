...
class Leaderboard {
	...
	get_date_range() {
		...
		let date_range_map = {
			"this week": [vmraid.datetime.week_start(), current_date],
			"this month": [vmraid.datetime.month_start(), current_date],
			"this quarter": [vmraid.datetime.quarter_start(), current_date],
			"this year": [vmraid.datetime.year_start(), current_date],
