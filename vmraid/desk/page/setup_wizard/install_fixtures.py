...
from vmraid.desk.doctype.global_search_settings.global_search_settings import update_global_search_doctypes
...
def update_genders():
	...
	for record in records:
		vmraid.get_doc(record).insert(ignore_permissions=True, ignore_if_duplicate=True)
...
def update_salutations():
	...
	for record in records:
		doc = vmraid.new_doc(record.get("doctype"))
		doc.update(record)
