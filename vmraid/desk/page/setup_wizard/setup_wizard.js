...
vmraid.setup.slides_settings = [
	{
		...
		onload: function (slide) {
			...
			let browser_language = vmraid.setup.utils.get_language_name_from_code(navigator.language);
...
vmraid.setup.utils = {
	...
	setup_region_fields: function (slide) {
		...
		*/
		let data = vmraid.setup.data.regional_data;
	...
	get_language_name_from_code: function (language_code) {
		return vmraid.setup.data.lang.codes_to_names[language_code] || "English";
	},
