...
test_records = vmraid.get_test_records('Note')

class TestNote(unittest.TestCase):
	def insert_note(self):
		vmraid.db.sql('delete from tabVersion')
		vmraid.db.sql('delete from tabNote')
		vmraid.db.sql('delete from `tabNote Seen By`')

		return vmraid.get_doc(dict(doctype='Note', title='test note',
	...
	def test_version(self):
		...
		version = vmraid.get_doc('Version', dict(docname=note.name))
