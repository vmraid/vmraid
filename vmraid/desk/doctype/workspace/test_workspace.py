...
class TestWorkspace(unittest.TestCase):
	...
	def tearDown(self):
		vmraid.db.delete("Workspace", {"module": "Test Module"})
		vmraid.db.delete("DocType", {"module": "Test Module"})
		vmraid.delete_doc("Module Def", "Test Module")
	...
	# 	if vmraid.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = vmraid.get_doc(
		{"doctype": "Module Def", "module_name": module_name, "app_name": "vmraid"}
	)
...
def create_workspace(**args):
	workspace = vmraid.new_doc("Workspace")
