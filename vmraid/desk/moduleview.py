...
from vmraid.desk.doctype.desktop_icon.desktop_icon import clear_desktop_icons_cache, set_hidden
...
def filter_by_restrict_to_domain(data):
	...
	doctypes = (
		vmraid.cache().get_value("domain_restricted_doctypes") or build_domain_restriced_doctype_cache()
	)
