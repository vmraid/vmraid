...
from vmraid.modules import get_module_path, load_doctype_module, scrub
from vmraid.translate import extract_messages_from_code, make_dict_from_messages
