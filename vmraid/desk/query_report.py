...
from vmraid.modules import scrub, get_module_path
...
def generate_report_result(report, filters=None, user=None, custom_columns=None):
	...
	return {
		...
		"status": None,
		"execution_time": vmraid.cache().hget("report_execution_time", report.name)
		or 0,
	}
...
def get_script(report_name):
	report = get_report_doc(report_name)
	module = report.module or vmraid.db.get_value(
	...
	return {
		...
		"execution_time": vmraid.cache().hget("report_execution_time", report_name)
		or 0,
	}
