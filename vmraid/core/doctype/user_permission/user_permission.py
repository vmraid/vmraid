...
class UserPermission(Document):
	...
	def on_update(self):
		vmraid.cache().hdel("user_permissions", self.user)
	...
	def validate_user_permission(self):
		...
		duplicate_exists = vmraid.db.get_all(
			self.doctype,
			filters={
				"allow": self.allow,
...
def clear_user_permissions(user, for_doctype):
	vmraid.only_for("System Manager")
	total = vmraid.db.count("User Permission", {"user": user, "allow": for_doctype})
