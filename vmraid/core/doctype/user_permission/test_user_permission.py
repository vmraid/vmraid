...
class TestUserPermission(unittest.TestCase):
	def setUp(self):
		...
		vmraid.db.delete("User Permission", {"user": ("in", test_users)})
	...
	def test_default_user_permission_corectness(self):
		...
		add_user_permissions(param)
		vmraid.db.delete("User Permission", filters={"for_value": test_blog.name})
		vmraid.delete_doc("Blog Post", test_blog.name)
	...
	def test_for_applicable_on_update_from_apply_to_all(self):
		...
		is_created_applicable_first = vmraid.db.exists(
			"User Permission", get_exists_param(user, applicable="Comment")
		)
		is_created_applicable_second = vmraid.db.exists(
	...
	def test_for_apply_to_all_on_update_from_applicable(self):
		...
		removed_applicable_first = vmraid.db.exists(
			"User Permission", get_exists_param(user, applicable="Comment")
		)
		removed_applicable_second = vmraid.db.exists(
			"User Permission", get_exists_param(user, applicable="Contact")
		)
