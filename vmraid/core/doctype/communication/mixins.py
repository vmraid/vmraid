...
from vmraid.utils import get_formatted_email, get_url, parse_addr
...
class CommunicationEmailMixin:
	...
	def filter_disabled_users(emails):
		...
		return vmraid.get_all("User", pluck="email", filters={"email": ["in", emails], "enabled": 0})
