...
from vmraid.core.doctype.data_import.test_importer import create_doctype_if_not_exists
...
class TestExporter(unittest.TestCase):
	...
	def test_exports_specified_fields(self):
		if not vmraid.db.exists(doctype_name, "Test"):
			doc = vmraid.get_doc(
			...
			doc = vmraid.get_doc(doctype_name, "Test")
	...
	def test_export_csv_response(self):
		...
		self.assertEqual(vmraid.response["doctype"], doctype_name)
