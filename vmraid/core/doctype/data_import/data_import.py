...
def validate_csv_import_file(path):
	if path.endswith(".csv"):
		...
		print('Import CSV files using the command "chair --site sitename data-import"')
		print("Or use the method vmraid.core.doctype.data_import.data_import.import_file")
		print()
