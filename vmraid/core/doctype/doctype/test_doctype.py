...
import vmraid
import unittest
from vmraid.core.doctype.doctype.doctype import (UniqueFieldnameError,
...
class TestDocType(unittest.TestCase):
	...
	def test_cancel_link_doctype(self):
		import json
		from vmraid.desk.form.linked_with import get_submitted_linked_docs, cancel_all_linked_docs
