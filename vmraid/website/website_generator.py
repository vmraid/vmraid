...
from vmraid.search.website_search import remove_document_from_index, update_index_for_path
from vmraid.website.utils import cleanup_page_name, clear_cache
...
class WebsiteGenerator(Document):
	...
	def send_indexing_request(self, operation_type="URL_UPDATED"):
		...
		if (
			vmraid.db.get_single_value("Website Settings", "enable_google_indexing")
			...
			vmraid.enqueue(
				"vmraid.website.doctype.website_settings.google_indexing.publish_site",
				url=url,
