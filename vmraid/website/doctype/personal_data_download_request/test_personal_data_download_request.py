...
import unittest
import json
from vmraid.website.doctype.personal_data_download_request.personal_data_download_request import get_user_data
...
class TestRequestPersonalData(unittest.TestCase):
	...
	def tearDown(self):
		vmraid.db.sql("""DELETE FROM `tabPersonal Data Download Request`""")
	...
	def test_file_and_email_creation(self):
		...
		file_count = vmraid.db.count('File', {
		...
		email_queue = vmraid.get_all('Email Queue',
			fields=['message'],
