...
class WebsiteTheme(Document):
	...
	def on_trash(self):
		if self.is_standard_and_not_valid_user():
			vmraid.throw(
				_("You are not allowed to delete a standard Website Theme"), vmraid.PermissionError
			)
	...
	def generate_bootstrap_theme(self):
		...
		self.theme_scss = vmraid.render_template(
			"vmraid/website/doctype/website_theme/website_theme_template.scss", self.as_dict()
		)
...
def get_scss(website_theme):
	...
	return vmraid.render_template(
		"vmraid/website/doctype/website_theme/website_theme_template.scss", context
	)
