...
class TestNotification(unittest.TestCase):
	...
	def test_new_and_save(self):
		...
		self.assertEqual(
			vmraid.db.get_value("Communication", communication.name, "subject"), "__testing__"
		)
	...
	def test_date_changed(self):
		...
		vmraid.get_doc(
			"Scheduled Job Type",
			dict(method="vmraid.email.doctype.notification.notification.trigger_daily_alerts"),
		).execute()
	...
	def test_cc_jinja(self):
		...
		vmraid.db.delete("User", {"email": "test_jinja@example.com"})
		vmraid.db.delete("Email Queue")
		...
		self.assertTrue(
			vmraid.db.get_value("Email Queue Recipient", {"recipient": "test_jinja@example.com"})
		)
	...
	def tearDownClass(cls):
		vmraid.delete_doc_if_exists("Notification", "ToDo Status Update")
		vmraid.delete_doc_if_exists("Notification", "Contact Status Update")
