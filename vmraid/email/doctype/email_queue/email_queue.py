...
from vmraid.email.queue import get_unsubcribed_url
from vmraid.email.email_body import add_attachment
...
class SendMailContext:
	...
	def get_tracker_str(self):
		tracker_url_html = \
			'<img src="https://{}/api/method/vmraid.core.doctype.communication.email.mark_email_as_seen?name={}"/>'
...
def on_doctype_update():
	...
	vmraid.db.add_index('Email Queue', ('status', 'send_after', 'priority', 'creation'), 'index_bulk_flush')
