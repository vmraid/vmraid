...
from vmraid.desk.form.document_follow import get_document_followed_by_user
from vmraid.desk.form.utils import add_comment
from vmraid.desk.like import toggle_like
from vmraid.query_builder import DocType
from vmraid.query_builder.functions import Cast_
from vmraid.share import add as share
...
class TestDocumentFollow(unittest.TestCase):
	...
	def tearDown(self):
		...
		vmraid.db.delete("Document Follow")
...
def get_user(document_follow=None):
	...
	if vmraid.db.exists("User", "test@docsub.com"):
		doc = vmraid.delete_doc("User", "test@docsub.com")
