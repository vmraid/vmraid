...
from vmraid.email.receive import Email
from vmraid.email.email_body import (replace_filename_with_cid,
					get_email, inline_style_in_html, get_header)
from vmraid.email.queue import get_email_queue
from vmraid.email.doctype.email_queue.email_queue import SendMailContext
from six import PY3
...
<div>
	...
	<img embed="assets/vmraid/images/vmraid-favicon.svg" />
</div>
'''
		email_text = '''
Hey John Doe!
...
'''
		...
		img_path = os.path.abspath('assets/vmraid/images/vmraid-favicon.svg')
...
Content-Disposition: inline; filename="vmraid-favicon.svg"
'''
...
'''
	...
	def test_replace_filename_with_cid(self):
		original_message = '''
			<div>
				<img embed="assets/vmraid/images/vmraid-favicon.svg" alt="test" />
...
From: test1_@erpadda.com
Reply-To: test2_@erpadda.com
""" + text_content_bytes
