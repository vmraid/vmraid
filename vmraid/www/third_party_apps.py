...
def delete_client(client_id):
	active_client_id_tokens = vmraid.get_all(
		"OAuth Bearer Token", filters=[["user", "=", vmraid.session.user], ["client", "=", client_id]]
	)
