...
const vmraid_path = path.resolve(__dirname, "..");
const chair_path = path.resolve(vmraid_path, "..", "..");
const sites_path = path.resolve(chair_path, "sites");
const apps_path = path.resolve(chair_path, "apps");
